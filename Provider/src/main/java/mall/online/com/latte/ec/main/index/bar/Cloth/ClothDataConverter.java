...
public class ClothDataConverter extends DataConverter {
    @Override
    public ArrayList<MultipleItemEntity> convert() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (typeId == 0) {
                type = ClothItemType.SINGLE_IMG;
            } else if (typeId == 1) {
                type = ClothItemType.DOUBLE_IMG;
            } else if (typeId == 2) {
                type = ClothItemType.HIGH_IMG;
            } else if (typeId == 3) {
                type = ClothItemType.BAR_VIEW;
            }
