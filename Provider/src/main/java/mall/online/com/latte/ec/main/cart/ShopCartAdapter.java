...
public class ShopCartAdapter extends IndexRecyclerAdapter {
    ...
    protected ShopCartAdapter(List<MultipleItemEntity> data, LatteDelegate delegate) {
        super(data);
        DELEGATE = delegate;
            ...
            case ItemType.SHOP_CART_ITEM:
                ...
                iconMinus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        final int count = Integer.parseInt(tvCount.getText().toString()) - 1;
                        if (Integer.parseInt(tvCount.getText().toString()) > 1) {
                            RestClient.builder()
                                    .loader(mContext)
                                    .url("http://139.199.5.153:3000/ec/cart/minus?id="+objectId+"&count="+count)
                ...
                iconPlus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        RestClient.builder()
                                .loader(mContext)
                                .url("http://139.199.5.153:3000/ec/cart/add?id="+objectId+"&count="+count)
                                .success(new ISuccess() {
                                    @Override
                                    public void onSuceess(String response) {
                                        int countNum = count;
                ...
                imageThumb.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String current = entity.getField(MultipleFields.ID);
                        final GoodsDetailDelegate delegate = GoodsDetailDelegate.create(current);
